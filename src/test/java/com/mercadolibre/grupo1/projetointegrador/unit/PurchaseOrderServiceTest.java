...
public class PurchaseOrderServiceTest {
    ...
    public void editExistentOrderExceptionTest() {
        ...
        // action
        RuntimeException runtimeException = Assertions.assertThrows(RuntimeException.class, () -> purchaseOrderService.editExistentOrder(1L));
    ...
    public void editExistentOrderOkTest() {
        ...
        PurchaseOrder editedOrder = purchaseOrderService.editExistentOrder(1L);
